            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="p-5">
                  ...
                  <form class="user" action="<?php echo base_url('masyarakat/login') ?>" method="post">
                    <div class="form-group">
                      <input name="username"  class="form-control form-control-user"  placeholder="Masukan username anda..." required>
                    </div>
                    <div class="form-group">
                  ...
                  <hr>
                    <a href="<?=base_url('masyarakat/registrasi')?>" class="btn btn-success btn-user btn-block">
